...
export default function TypingPromptInput() {
  const prompts = [
    "Analyze our cloud infrastructure costs and identify optimization opportunities...",
    "Audit our CI/CD pipeline and recommend automation improvements...",
    "Review our security posture and compliance readiness for Series A...",
    "Assess our monitoring and alerting setup for production reliability...",
    "Evaluate our disaster recovery plan and backup strategies...",
  ]
      ...
      <div className="relative group">
        ...
        <div className="relative">
          <Input
            ...
            bg-white/80 border-primary/10 text-foreground shadow-[0_4px_20px_hsl(var(--primary)/0.2)]"
            placeholder=""
            value={displayText}
            readOnly
          />
